...
An arbitrary state of a cavity and a atom can be described by a total density operator $\rho(t)$. %The total density operator can be written in the Hilbert space $ H_ {tot}= H_{system}+H_{bath}$. 
